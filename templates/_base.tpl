...
<head>
  ...
  <title>{block name=title}Social and Sport Club{/block}</title>
  ...
  {* Block used to add custom styles for each page *}
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php.html">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>ORT Uruguay University - Social and Sport Club&copy;</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  {* Block used to add custom javascripts for each page *}
