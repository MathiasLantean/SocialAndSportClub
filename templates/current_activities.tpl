...
{if empty($activities)}
    <div class="col-lg-6 col-md-8 text-center">
        <p class="lead text-gray-800 mb-5">You are not enrolled in activities</p>
        <p class="text-gray-500 mb-0">It looks like you are a little lazy, enroll you in any activity, please...</p>
    </div>
{/if}
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form action="doLeaveActivity.php" method="post">
                ...
                <button type="submit" class="btn btn-secondary btn-icon-split float-right">
